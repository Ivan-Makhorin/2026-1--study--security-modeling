# # Параметрическое исследование зависимости от интенсивности атак
# 
# **Цель:** изучить, как изменение интенсивности $\lambda$ (атак/час) влияет на
# распределение числа атак за час и на вероятность $P(N_1 > 10)$.
# 
# В этом скрипте мы:
# - задаём набор значений $\lambda = [2.0,\;5.0,\;8.0,\;12.0,\;15.0]$;
# - для каждого значения либо загружаем ранее сохранённые результаты (если есть),
#   либо выполняем симуляцию и сохраняем;
# - строим детальные графики для каждого $\lambda$;
# - строим общий график зависимости вероятности $P(>10)$ от $\lambda$;
...
# ## Общий график зависимости вероятности от λ
