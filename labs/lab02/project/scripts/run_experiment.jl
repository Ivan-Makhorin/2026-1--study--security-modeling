# # Однократный запуск эксперимента с сохранением результатов
# 
# Этот скрипт выполняет симуляцию для заданных параметров и сохраняет все результаты в JLD2-файл.
# 
# ## Активация проекта и подключение пакетов
...
# ## Функция запуска симуляции и оценки вероятности
...
# ## Сохранение или загрузка результатов
