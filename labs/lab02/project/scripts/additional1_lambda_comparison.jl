# # Сравнение вероятностей P(>10) для разных интенсивностей
# 
# Скрипт вычисляет эмпирические и теоретические вероятности для λ = 2, 8, 12.
# Результаты сохраняются в CSV и график.
# 
