# # Бутстреп-доверительный интервал для вероятности P(>10)
# 
# Генерируем выборку объёма 10000 часов, оцениваем вероятность,
# затем строим 95% доверительный интервал методом бутстрепа.
# 
