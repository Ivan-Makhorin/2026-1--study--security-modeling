# # Модуль simulation.jl
# Ядро моделирования конфликта «Защитник–Нападающий».
# Содержит функции построения матриц и поиска равновесия Нэша.

using LinearAlgebra

# ## 1. Построение платёжных матриц
# Возвращает (A, D) – выигрыши Нападающего и Защитника.
...
# ## 2. Поиск равновесия Нэша для игры 2×2
# Возвращает именованный кортеж (p, q, type).
function mixed_nash_2x2(A::Matrix{Float64}, D::Matrix{Float64})
    # Проверка чистых равновесий
